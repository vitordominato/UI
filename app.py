...
if pagina == "Painel de Internações":
    ...
    if df_pacientes.empty:
        st.warning("Nenhum paciente registrado.")
    else:
        ...
        if filtro.empty:
            st.info("Nenhum paciente com os filtros aplicados.")
        else:
    ...
    if "editar" in st.session_state:
        ...
        if not linha.empty:
            ...
            with st.form("editar_paciente"):
                ...
                df_pacientes.at[i, "Intercorrência"] = st.selectbox("Intercorrência", ["", "Código Azul", "Código Amarelo", "Código Laranja", "Código Verde", "Outro"], index=0)
...
# ------------------- CADASTRO DE PACIENTE -------------------
    ...
    with st.form("form_paciente"):
        ...
        origem = st.text_input("Origem do Paciente")
