...
if menu == "Painel de Internações":
    ...
    if df_pacientes.empty:
        ...
        if st.sidebar.button("🌙 Modo Plantão"):
            ...
            df_pacientes["Data/Hora da Intercorrência"] = pd.to_datetime(df_pacientes["Data/Hora da Intercorrência"], errors='coerce')
            df_pacientes = df_pacientes[
                df_pacientes["Data/Hora da Intercorrência"] >= ontem
            ]
