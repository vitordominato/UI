...
with st.sidebar:
    ...
    unidade_sel = st.selectbox("Unidade", ["(Todas)"] + unidades, index=0, key="unidade_filtro") if unidades else "(Todas)"
    ...
    andar_sel = st.selectbox("Andar", ["(Todos)"] + andares, index=0, key="andar_filtro") if andares else "(Todos)"
    ...
    medico_sel = st.selectbox("Médico", ["(Todos)"] + medicos, index=0, key="medico_filtro") if medicos else "(Todos)"
