...
# Exporta dados de leitos para Google Sheets ao iniciar o app
import pandas as pd
import os
try:
    ...
    salvar_df_no_google_sheets(
        ...
        'leitos',              # Nome da aba
        os.path.join('secrets', 'irah-app-14b9444a55a6.json')
    )
    st.info('Dados de leitos exportados para Google Sheets.')
except Exception as e:
    st.warning(f'Falha ao exportar dados para Google Sheets: {e}')
