...
def inicializar_firebase():
    ...
    if not firebase_initialized:
        try:
            ...
            # DATABASE_URL_CONFIG agora é um dict com 'value'
            database_url = st.secrets["DATABASE_URL_CONFIG"]["value"] if isinstance(st.secrets["DATABASE_URL_CONFIG"], dict) else st.secrets["DATABASE_URL_CONFIG"]
